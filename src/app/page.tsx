 ...
 * Version stabilisée pour éliminer les erreurs d'hydratation et forcer l'affichage des annonces réelles.
 */
...
export default function HomePage() {
  ...
  // REQUÊTE PUBLIQUE : Toujours chargée, peu importe l'état de connexion
  ...
  // STRUCTURE RACINE SYNCHRONISÉE POUR L'HYDRATATION
  return (
